...
//  ZDialog
//
//  Created by zabih-raadco on 09/18/2019.
//  Copyright (c) 2019 zabih-raadco. All rights reserved.
//
...
class ViewController: UIViewController {
    ...
    lazy var alertDialog1 = ZAlertDialog()
    lazy var alertDialog2 = ZAlertDialog()
    ...
    @IBAction func onShowAlertDialogTap_longMsg(_ sender: UIButton) {
        alertDialog1
            .setTitle("long message sample with scrollable")
            .setMessage(longMsg)
            .showDialog(self)
    }

    
    @IBAction func onShowAlertDialogTap_normalMsg(_ sender: UIButton) {
        alertDialog2
